...
3+ years building production React applications — from e-commerce platforms to high-performance web interfaces. I specialize in clean component architecture, performance optimization, and turning complex requirements into maintainable code.

**What I bring:**
- Strong React fundamentals (hooks, context, composition patterns)
- TypeScript for type-safe development
- Performance mindset (code splitting, lazy loading, caching)
- AI-assisted development workflow (Cursor, Claude, Copilot)
